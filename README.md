...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-05-30 10:05 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-34360`**](https://nvd.nist.gov/vuln/detail/CVE-2026-34360) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.8**<br><sub>HAPI FHIR is a complete implementation of the HL7 FHIR standard for healthcare interoperabili...</sub><br><sub>Published: `2026-03-31`</sub> | [**Charter**](https://www.google.com/search?q=Charter%20data%20breach&tbm=nws) &nbsp; <sub>`charter.com`</sub><br><sub>**4,851,517** accounts compromised</sub><br><sub>Data: `email addresses` `job titles` `names` &nbsp;·&nbsp; Added: `2026-05-28`</sub> |
| [**`CVE-2026-34359`**](https://nvd.nist.gov/vuln/detail/CVE-2026-34359) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.4**<br><sub>HAPI FHIR is a complete implementation of the HL7 FHIR standard for healthcare interoperabili...</sub><br><sub>Published: `2026-03-31`</sub> | [**Kemper**](https://www.google.com/search?q=Kemper%20data%20breach&tbm=nws) &nbsp; <sub>`kemper.com`</sub><br><sub>**269,299** accounts compromised</sub><br><sub>Data: `email addresses` `names` `partial credit card data` &nbsp;·&nbsp; Added: `2026-05-28`</sub> |
| [**`CVE-2026-24165`**](https://nvd.nist.gov/vuln/detail/CVE-2026-24165) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.8**<br><sub>NVIDIA BioNeMo contains a vulnerability where a user could cause a deserialization of untrust...</sub><br><sub>Published: `2026-03-31`</sub> | [**Mytheresa**](https://www.google.com/search?q=Mytheresa%20data%20breach&tbm=nws) &nbsp; <sub>`mytheresa.com`</sub><br><sub>**84,108** accounts compromised</sub><br><sub>Data: `email addresses` `names` `partial credit card data` &nbsp;·&nbsp; Added: `2026-05-27`</sub> |
<!-- SECURITY-END -->
---
