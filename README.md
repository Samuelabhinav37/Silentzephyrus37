...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-06-27 10:14 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-42422`**](https://nvd.nist.gov/vuln/detail/CVE-2026-42422) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.8**<br><sub>OpenClaw before 2026.4.8 contains a role bypass vulnerability in the device.token.rotate func...</sub><br><sub>Published: `2026-04-28`</sub> | [**AmericanTower**](https://www.google.com/search?q=AmericanTower%20data%20breach&tbm=nws) &nbsp; <sub>`americantower.com`</sub><br><sub>**216,601** accounts compromised</sub><br><sub>Data: `email addresses` `job titles` `names` &nbsp;·&nbsp; Added: `2026-06-26`</sub> |
| [**`CVE-2026-42421`**](https://nvd.nist.gov/vuln/detail/CVE-2026-42421) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.4**<br><sub>OpenClaw before 2026.4.8 contains a session management vulnerability where existing WebSocket...</sub><br><sub>Published: `2026-04-28`</sub> | [**MadisonSquareGardenSports**](https://www.google.com/search?q=MadisonSquareGardenSports%20data%20breach&tbm=nws) &nbsp; <sub>`msgsports.com`</sub><br><sub>**9,796,738** accounts compromised</sub><br><sub>Data: `customer service records` `email addresses` `names` &nbsp;·&nbsp; Added: `2026-06-24`</sub> |
| [**`CVE-2026-42420`**](https://nvd.nist.gov/vuln/detail/CVE-2026-42420) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.3**<br><sub>OpenClaw before 2026.4.8 contains improper input validation in base64 decode paths that alloc...</sub><br><sub>Published: `2026-04-28`</sub> | [**JCPenney**](https://www.google.com/search?q=JCPenney%20data%20breach&tbm=nws) &nbsp; <sub>`jcpenny.com`</sub><br><sub>**368,418** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `government issued ids` &nbsp;·&nbsp; Added: `2026-06-20`</sub> |
<!-- SECURITY-END -->
---
