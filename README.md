...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-07-16 10:15 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-26462`**](https://nvd.nist.gov/vuln/detail/CVE-2026-26462) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.3**<br><sub>Offline Hospital Management System 5.3.0 allows remote code execution due to an improper Elec...</sub><br><sub>Published: `2026-05-18`</sub> | [**Fluke**](https://www.google.com/search?q=Fluke%20data%20breach&tbm=nws) &nbsp; <sub>`fluke.com`</sub><br><sub>**821,100** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-07-15`</sub> |
| [**`CVE-2026-42009`**](https://nvd.nist.gov/vuln/detail/CVE-2026-42009) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>A flaw was found in gnutls. A remote attacker could exploit an issue in the Datagram Transpor...</sub><br><sub>Published: `2026-05-18`</sub> | [**GooseCreek**](https://www.google.com/search?q=GooseCreek%20data%20breach&tbm=nws) &nbsp; <sub>`goosecreek.com`</sub><br><sub>**6,574,121** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-07-15`</sub> |
| [**`CVE-2026-8803`**](https://nvd.nist.gov/vuln/detail/CVE-2026-8803) ![LOW](https://img.shields.io/badge/LOW-339900?style=flat-square) **3.7**<br><sub>A flaw has been found in opensourcepos Open Source Point of Sale up to 3.4.2. Impacted is the...</sub><br><sub>Published: `2026-05-18`</sub> | [**GlendaleCommunityCollege**](https://www.google.com/search?q=GlendaleCommunityCollege%20data%20breach&tbm=nws) &nbsp; <sub>`glendale.edu`</sub><br><sub>**793,925** accounts compromised</sub><br><sub>Data: `academic records` `dates of birth` `email addresses` &nbsp;·&nbsp; Added: `2026-07-11`</sub> |
<!-- SECURITY-END -->
---
