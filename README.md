...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-05-19 11:26 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-31904`**](https://nvd.nist.gov/vuln/detail/CVE-2026-31904) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>The WebSocket Application Programming Interface lacks restrictions on the number of authentic...</sub><br><sub>Published: `2026-03-20`</sub> | [**CTT**](https://www.google.com/search?q=CTT%20data%20breach&tbm=nws) &nbsp; <sub>`ctt.pt`</sub><br><sub>**468,124** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-05-19`</sub> |
| [**`CVE-2026-31903`**](https://nvd.nist.gov/vuln/detail/CVE-2026-31903) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>The WebSocket Application Programming Interface lacks restrictions on the number of authentic...</sub><br><sub>Published: `2026-03-20`</sub> | [**ADDI**](https://www.google.com/search?q=ADDI%20data%20breach&tbm=nws) &nbsp; <sub>`addi.com`</sub><br><sub>**34,532,941** accounts compromised</sub><br><sub>Data: `age groups` `credit scores` `device information` &nbsp;·&nbsp; Added: `2026-05-18`</sub> |
| [**`CVE-2026-29796`**](https://nvd.nist.gov/vuln/detail/CVE-2026-29796) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.4**<br><sub>WebSocket endpoints lack proper authentication mechanisms, enabling attackers to perform unau...</sub><br><sub>Published: `2026-03-20`</sub> | [**Abrigo**](https://www.google.com/search?q=Abrigo%20data%20breach&tbm=nws) &nbsp; <sub>`abrigo.com`</sub><br><sub>**711,099** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-05-14`</sub> |
<!-- SECURITY-END -->
---
