...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-05-29 11:34 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-32883`**](https://nvd.nist.gov/vuln/detail/CVE-2026-32883) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.9**<br><sub>Botan is a C++ cryptography library. From version 3.0.0 to before version 3.11.0, during X509...</sub><br><sub>Published: `2026-03-30`</sub> | [**Charter**](https://www.google.com/search?q=Charter%20data%20breach&tbm=nws) &nbsp; <sub>`charter.com`</sub><br><sub>**4,851,517** accounts compromised</sub><br><sub>Data: `email addresses` `job titles` `names` &nbsp;·&nbsp; Added: `2026-05-28`</sub> |
| [**`CVE-2026-32877`**](https://nvd.nist.gov/vuln/detail/CVE-2026-32877) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.2**<br><sub>Botan is a C++ cryptography library. From version 2.3.0 to before version 3.11.0, during SM2 ...</sub><br><sub>Published: `2026-03-30`</sub> | [**Kemper**](https://www.google.com/search?q=Kemper%20data%20breach&tbm=nws) &nbsp; <sub>`kemper.com`</sub><br><sub>**269,299** accounts compromised</sub><br><sub>Data: `email addresses` `names` `partial credit card data` &nbsp;·&nbsp; Added: `2026-05-28`</sub> |
| [**`CVE-2026-32696`**](https://nvd.nist.gov/vuln/detail/CVE-2026-32696) ![LOW](https://img.shields.io/badge/LOW-339900?style=flat-square) **3.1**<br><sub>NanoMQ MQTT Broker (NanoMQ) is an all-around Edge Messaging Platform. In NanoMQ version 0.24....</sub><br><sub>Published: `2026-03-30`</sub> | [**Mytheresa**](https://www.google.com/search?q=Mytheresa%20data%20breach&tbm=nws) &nbsp; <sub>`mytheresa.com`</sub><br><sub>**84,108** accounts compromised</sub><br><sub>Data: `email addresses` `names` `partial credit card data` &nbsp;·&nbsp; Added: `2026-05-27`</sub> |
<!-- SECURITY-END -->
---
